    ...
    public class AppDelegate : UIApplicationDelegate
    {
        ...
        public override bool FinishedLaunching (UIApplication application, NSDictionary launchOptions)
        {
            /*_backpackPlannerState = new BackpackPlannerState(
                ...
                new IOSSettingsManager(Android.Support.V7.Preferences.PreferenceManager.GetDefaultSharedPreferences(this)),
                new IOSPlayServicesManager(),
                _permissionRequestFactory
            );

            _backpackPlannerState.InitAsync().Wait();

            _backpackPlannerState.DatabaseState.InitAsync(_backpackPlannerState, Environment.GetFolderPath(Environment.SpecialFolder.Personal), DatabaseState.DatabaseName).Wait();*/
