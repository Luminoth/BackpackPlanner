...
{
    public abstract class BaseModelEntryViewHolder<T, TM, TV> : BaseViewHolder<T>, INotifyPropertyChanged
...
#region Events
        ...
        protected BaseModelEntryViewHolder(BaseActivity activity)
            : base(activity)
        {
        }
    }
