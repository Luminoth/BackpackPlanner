...
namespace EnergonSoftware.BackpackPlanner.Droid.Adapters.Gear.Systems
{
    ...
    {
        private sealed class GearSystemEntryViewHolder : BaseModelEntryViewHolder<GearSystemEntry<T>, T, GearSystem>
        {
        ...
        {
            GearSystemEntryViewHolder viewHolder = new GearSystemEntryViewHolder(view, BaseActivity);
