...
namespace EnergonSoftware.BackpackPlanner.Droid.Fragments.Trips.Plans
{
    public sealed class AddTripPlanFragment : AddItemFragment<TripPlan>
    {
        ...
        protected override int CleanTitleResource => Resource.String.title_add_trip_plan;

        protected override int DirtyTitleResource => Resource.String.title_add_trip_plan_dirty;
